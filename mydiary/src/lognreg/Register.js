            ...
            <section>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    className={userFocus&&user&&!validName?"instruction":"offscreen"}>
                        ...
                        Letras, numeros, underlines, hifens permitidos <br />
                    </p>
                ...
                <p id="pwdnote" 
                        ...
                        Deve incluir pelo menos uma letra maiscula, minuscula, numero, e um simbolo especial.<br />
                ...
                <p id="confirmenote" 
                        ...
                        <FontAwesomeIcon icon={faInfoCircle} />
                        Deve ser igual a senha inserida anteriormente
                    </p>
                    <button
